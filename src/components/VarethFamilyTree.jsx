  ...
  useEffect(() => {
    const chart = new FamilyTree(document.getElementById("tree"), {
      ...
      nodes: [
        ...
        { id: 3, pids: [4], mid: 1, fid: 2, name: "Dravanus Vareth", title: "Hijo de Selene"},
        ...
        { id: 7, pids: [8], mid: 3, name: "Elira Vareth", title: "Hija de Dravanus" },
        { id: 8, pids: [7], name: "Cedric Marbrand", title: "Esposo de Elira" },
        { id: 9, pids: [10], mid: 3, name: "Syrenia Vareth", title: "Hija de Dravanus" },
        { id: 10, pids: [9], name: "Darian Karnus", title: "Esposo de Syrenia" },
        { id: 11, pids: [12], mid: 7, name: "Thalindra Vareth", title: "Hija de Elira" },
        { id: 12, pids: [11], name: "Lucan Valtheris", title: "Esposo de Thalindra" },
        { id: 13, mid: 7, name: "Zyphora Vareth", title: "Hija de Elira" },
        { id: 14, pids: [15], mid: 9, name: "Miriel Vareth", title: "Hija de Syrenia" },
        { id: 15, pids: [14], name: "Cassian Voren", title: "Esposo de Miriel" },
        { id: 16, mid: 14, name: "Selendra Vareth", title: "Hija de Miriel" },
        { id: 17, pids: [18], mid: 11, name: "Varethia Vareth", title: "Hija de Thalindra" },
        { id: 18, pids: [17], name: "Edwin Castrel", title: "Esposo de Varethia" },
        { id: 19, mid: 5, name: "Seraphina Vareth", title: "Hija de Alyndra" },
        { id: 20, pids: [21], mid: 5, name: "Lyara Vareth", title: "Hija de Alyndra"},
        { id: 21, pids: [20], name: "Sirius Ravencroft", title: "Esposo de Lyara" },
        { id: 22, pids: [37], mid: 20, name: "Sylwen Vareth", title: "Hija de Lyara" },
        { id: 23, mid: 20, name: "Ysandra Vareth", title: "Hija de Lyara" },
        { id: 24, pids: [25], mid: 23,  name: "Vaelith Vareth", title: "Hija de Ysandra" },
        { id: 25, pids: [24], name: "Aldren Moren", title: "Esposo de Vaelith" },
        { id: 26, pids: [27], mid: 5, name: "Ysilda Vareth", title: "Hija Alyndra" },
        { id: 27, pids: [26], name: "Faelan Draevos", title: "Esposo de Ysilda" },
        { id: 28, mid: 26, name: "Althira Vareth", title: "Hija de Ysilda" },
        { id: 29, pids: [30], mid: 26, name: "Vaelora Vareth", title: "Hija Ysilda" },
        { id: 30, pids: [29], name: "Orion Velkyr", title: "Esposo de Vaelora" },
        { id: 31, pids: [32], mid: 29, name: "Nysara Vareth", title: "Hija de Vaelora" },
        { id: 32, pids: [31], name: "Thalion Eldros", title: "Esposo de Nysara" },
        { id: 33, pids: [34], mid: 26,  name: "Syrelle Vareth", title: "Hija" },
        { id: 34, pids: [33], name: "Damarion Kael", title: "Esposo de Syrelle" },
        { id: 35, pids: [36], mid: 5,  name: "Elaria Vareth", title: "Hija de Alyndra" },
        { id: 36, pids: [35], name: "Marko Marbrand", title: "Esposo de Elaria" },
        { id: 37, pids: [22], name: "Gideon Stormbane", title: "Esposo de Sylwen" },
        { id: 38, pids: [39], mid: 35, name: "Kaelith Vareth", title: "Hija de Elaria" },
        { id: 39, pids: [38], name: "Malrik Dorn", title: "Esposo de Kaelith" },
        { id: 40, mid: 38, name: "Elyndra Vareth", title: "Hija de Kaelith" },
      ],
    });
  }, []);
